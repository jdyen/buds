...
# Effects of traits on resprouting probability
get(plot_type)(file = paste0("outputs/plots/Fig1.", file_type), width = width_set, height = height_set - 1,
...
# fitted depth distributions under clip treatment
...
# Depth distributions under burn treatment
...
# Differences between clipping and burning treatment (positive = burn greater than clip)
...
# function-valued trait effects
get(plot_type)(file = paste0("outputs/plots/Fig5.", file_type), width = width_set, height = height_set + 3,
               units = unit_set, res = res_set)
...
# Pairwise comparison of growth forms under the clip treatment 
get(plot_type)(file = paste0("outputs/plots/FigS1.", file_type), width = width_set, height = height_set, units = unit_set, res = res_set)
...
# Pairwise comparison of growth forms under the burn treatment 
get(plot_type)(file = paste0("outputs/plots/FigS2.", file_type), width = width_set, height = height_set, units = unit_set, res = res_set)
plot_name <- c("Forbs, Grasses",
               "Forbs, Sub-shrubs",
               "Forbs, Woody plants",
               "Grasses, Sub-shrubs",
...
# effect of max ht under clip treatment
...
# Effect of max ht under burn treatment
...
# Effect of SLA under clip treatment
get(plot_type)(file = paste0("outputs/plots/FigS7.", file_type), width = width_set, height = height_set, units = unit_set, res = res_set)
...
# Effect of SLA under burn treatment
get(plot_type)(file = paste0("outputs/plots/FigS8.", file_type), width = width_set, height = height_set, units = unit_set, res = res_set)
plot_name <- attr(trait_data$SLAstd, "scaled:center") + trait_seq[[3]] * attr(trait_data$SLAstd, "scaled:scale") 
par(mfrow = c(2, 2), mar = c(5.1, 5.1, 1.8, 1.1))
ylim_set <- c(0, 2.5)
xlim_set <- c(-3, 48)
